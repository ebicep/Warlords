...
public abstract class LeaderboardGameType<T extends AbstractDatabaseStatInformation> {
    ...
    public void addBaseLeaderboards(LeaderboardCategory<T> leaderboardCategory) {
        ...
        leaderboards.add(new Leaderboard("Wins",
                new Location(MAIN_LOBBY, -2558.5, 56, 712.5),
        ...
        leaderboards.add(new Leaderboard("Losses", new Location(MAIN_LOBBY, -2608.5, 52, 728.5),
        ...
        leaderboards.add(new Leaderboard("Plays", new Location(MAIN_LOBBY, -2564.5, 56, 712.5),
        ...
        leaderboards.add(new Leaderboard("Kills", new Location(MAIN_LOBBY, -2552.5, 56, 712.5),
        ...
        leaderboards.add(new Leaderboard("Assists", new Location(MAIN_LOBBY, -2616.5, 52, 733.5),
        ...
        leaderboards.add(new Leaderboard("Deaths", new Location(MAIN_LOBBY, -2616.5, 52, 723.5),
        ...
        leaderboards.add(new Leaderboard("Damage", new Location(MAIN_LOBBY, -2600.5, 52, 723.5),
        ...
        leaderboards.add(new Leaderboard("Healing", new Location(MAIN_LOBBY, -2608.5, 52, 719.5),
        ...
        leaderboards.add(new Leaderboard("Absorbed", new Location(MAIN_LOBBY, -2600.5, 52, 733.5),
        ...
        leaderboards.add(new Leaderboard("DHP", new Location(MAIN_LOBBY, -2619.5, 66.5, 721.5),
        ...
        leaderboards.add(new Leaderboard("DHP Per Game", new Location(MAIN_LOBBY, -2546.5, 56, 712.5),
        ...
        leaderboards.add(new Leaderboard("Kills Per Game", new Location(MAIN_LOBBY, -2619.5, 66.5, 735.5),
        ...
        leaderboards.add(new Leaderboard("Deaths Per Game", new Location(MAIN_LOBBY, -2608.5, 67, 738.5),
        ...
        leaderboards.add(new Leaderboard("Kills/Assists Per Game", new Location(MAIN_LOBBY, -2608.5, 67, 719.5),
        ...
        leaderboards.add(new Leaderboard("Experience", new Location(MAIN_LOBBY, -2526.5, 57, 744.5),
