...
public class DebugCommand extends BaseCommand {
    ...
    public void respawn(CommandIssuer issuer, @Default(SELF) WarlordsPlayer target) {
        target.respawn();
    }
    ...
    public void setEnergy(CommandIssuer issuer, @Values("enable|disable") String option, @Default(SELF) WarlordsPlayer target) {
    ...
    public void setCooldown(CommandIssuer issuer, @Values("enable|disable") String option, @Default(SELF) WarlordsPlayer target) {
    ...
    public void setTakeDamage(CommandIssuer issuer, @Values("enable|disable") String option, @Default(SELF) WarlordsPlayer target) {
        boolean enable = option.equals("enable");
    ...
    public void setCrits(CommandIssuer issuer, @Values("enable|disable") String option, @Default(SELF) WarlordsPlayer target) {
        boolean enable = option.equals("enable");
    ...
    public void heal(CommandIssuer issuer, @Default("1000") @Conditions("limits:min=0,max=100000") Integer amount, @Default(SELF) WarlordsPlayer target) {
    ...
    public void damage(CommandIssuer issuer, @Default("1000") @Conditions("limits:min=0,max=100000") Integer amount, @Default(SELF) WarlordsPlayer target) {
