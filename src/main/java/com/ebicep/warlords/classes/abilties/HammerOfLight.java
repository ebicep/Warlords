...
public class HammerOfLight extends AbstractAbility {
    ...
    public void onActivate(WarlordsPlayer wp, Player player) {
        ...
        DamageHealCircle damageHealCircle = new DamageHealCircle(wp, player.getTargetBlock((HashSet<Byte>) null, 25).getLocation().add(1, 0, 1), radius, 8, minDamageHeal, maxDamageHeal, critChance, critMultiplier, name);
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                for (WarlordsPlayer warlordsPlayer : PlayerFilter
                    .entitiesAround(damageHealCircle.getLocation(), radius, 6, radius)
                    .isAlive()
                ) {
