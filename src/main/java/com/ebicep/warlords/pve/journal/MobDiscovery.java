...
public final class MobDiscovery {
    ...
    static {
        ...
        put(Mob.CENTURION, "Centurion is a Nameless Crown bruiser with enormous health and steady crushing melee. He has no flashy phase kit yet—survive his raw pressure and keep healers ready. Treat the fight as a pure tank-and-spank burn.");
        ...
        put(Mob.EVENT_CALAMITY_CORE, "Calamity Core is the longest fuse at 60 seconds and summons elite packs while Chaos debuffs the party. Stay on the core and peel only what you must. Finish before Core Explosion true-damages the raid.");
