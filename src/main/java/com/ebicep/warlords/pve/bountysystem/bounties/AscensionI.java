...
public class AscensionI extends AbstractBounty implements TracksOutsideGame, LifetimeCost, LifetimeRewardSpendable3 {
    ...
    public String getDescription() {
        return "Prestige " + getTarget() + " specs.";
    }
