...
public enum Bounty {
    ...
    ASSIST_I(AssistI.class, AssistI::new),
    ...
    ENDURE_I(EndureI.class, EndureI::new),
    ENGAGE_I(EngageI.class, EngageI::new),
    ...
    INVESTIGATE_I(InvestigateI.class, InvestigateI::new),
    LUCKY_I(LuckyI.class, LuckyI::new),
    RECOUP_I(RecoupI.class, RecoupI::new),
    PROSPECTOR_I(ProspectorI.class, ProspectorI::new),
    ...
    TRIUMPH_I(TriumphI.class, TriumphI::new),
    // Weekly bounties
    ...
    INVESTIGATE_II(InvestigateII.class, InvestigateII::new),
    ...
    ANOMALIST_I(AnomalistI.class, AnomalistI::new),
    ARTISAN_I(ArtisanI.class, ArtisanI::new),
    ASCENSION_I(AscensionI.class, AscensionI::new),
    BOUNDLESS_I(BoundlessI.class, BoundlessI::new),
    BULWARK_I(BulwarkI.class, BulwarkI::new),
    CARNAGE_I(CarnageI.class, CarnageI::new),
    ...
    EXECUTIONER_I(ExecutionerI.class, ExecutionerI::new),
    ...
    RESTORATION_I(RestorationI.class, RestorationI::new),
    SENTINEL_I(SentinelI.class, SentinelI::new),
    SYNTHESIZER_I(SynthesizerI.class, SynthesizerI::new),
    WANDERER_I(WandererI.class, WandererI::new),
