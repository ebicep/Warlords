...
public class CarnageI extends AbstractBounty implements TracksPostGame, LifetimeCost, LifeTimeRewardSpendable4 {
    ...
    public String getDescription() {
        return "Deal 2 billion damage in any gamemode.";
    }
