...
public class ScrapII extends AbstractBounty implements TracksOutsideGame, WeeklyCost, WeeklyRewardSpendable5 {
    ...
    public void onItemScrap(ItemScrapEvent event) {
        ...
        if (event.getItem().getTier() == ItemTier.BETA) {
            value++;
        }
    }
    ...
    public String getDescription() {
        return "Scrap " + getTarget() + " Beta Items.";
    }
