...
public class ScrapIII extends AbstractBounty implements TracksOutsideGame, WeeklyCost, WeeklyRewardSpendable5 {
    ...
    public void onItemScrap(ItemScrapEvent event) {
        ...
        if (event.getItem().getTier() == ItemTier.GAMMA) {
            value++;
        }
    }
    ...
    public String getDescription() {
        return "Scrap " + getTarget() + " Gamma Item.";
    }
