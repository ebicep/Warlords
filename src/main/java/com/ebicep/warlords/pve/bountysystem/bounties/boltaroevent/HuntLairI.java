...
public class HuntLairI extends AbstractBounty implements TracksDuringGame, EventCost, FightersGloryReward1 {
    ...
    public void onKill(WarlordsDeathEvent event) {
        if (event.getWarlordsEntity() instanceof WarlordsNPC warlordsNPC && warlordsNPC.getMob() instanceof Mob) {
            newKills++;
        }
    }
