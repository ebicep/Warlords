...
public class LegendaryFlux extends AbstractLegendaryWeapon implements PassiveCounter {
    ...
    public LegendaryFlux(UUID uuid) {
        super(uuid);
    }

    public LegendaryFlux(AbstractLegendaryWeapon copy) {
        super(copy);
    }
    ...
    public TextComponent getPassiveEffect() {
        return Component.text("Spending energy grants Flux (", NamedTextColor.GRAY)
                        ...
                        .append(Component.text(" ability cooldown reduction for " + BUFF_DURATION_SECONDS + " seconds. Has a cooldown of " + COOLDOWN + " seconds.",
                                NamedTextColor.GRAY
                        ));
    }
