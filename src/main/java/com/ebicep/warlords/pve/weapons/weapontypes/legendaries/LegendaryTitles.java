...
public enum LegendaryTitles {
    ...
    VORPAL("Vorpal", LegendaryVorpal.class, LegendaryVorpal::new, LegendaryVorpal::new, Material.ORANGE_STAINED_GLASS_PANE),
    ...
    ENHANCED("Enhanced", LegendaryEnhanced.class, LegendaryEnhanced::new, LegendaryEnhanced::new, Material.ORANGE_STAINED_GLASS_PANE),
    ...
    INANITION("Inanition", LegendaryInanition.class, LegendaryInanition::new, LegendaryInanition::new, Material.ORANGE_STAINED_GLASS_PANE),
    ...
    CHAOTIC("Chaotic", LegendaryChaotic.class, LegendaryChaotic::new, LegendaryChaotic::new, Material.ORANGE_STAINED_GLASS_PANE),
