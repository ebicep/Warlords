...
public abstract class AbstractSlime extends AbstractMob<CustomSlime> {
    ...
    public AbstractSlime(
        ...
        super(new CustomSlime(spawnLocation.getWorld()), spawnLocation, name, mobTier, ee, maxHealth, walkSpeed, damageResistance, minMeleeDamage, maxMeleeDamage, abilities);
    }
}
