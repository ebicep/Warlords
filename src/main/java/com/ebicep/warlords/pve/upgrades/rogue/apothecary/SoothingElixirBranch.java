...
public class SoothingElixirBranch extends AbstractUpgradeBranch<SoothingElixir> {
    ...
    public SoothingElixirBranch(AbilityTree abilityTree, SoothingElixir ability) {
        ...
        masterUpgrade2 = new Upgrade(
                ...
                "Soothing Elixir - Master Upgrade",
                """
                        Allies hit by Soothing Elixir, including the caster, have all current debuffs removed and become immune to debuffs for 5s. Additionally, for every target hit, increase the users max HP by 1.5% (max 25%) for 5s.
                        """,
                50000,
                () -> {
