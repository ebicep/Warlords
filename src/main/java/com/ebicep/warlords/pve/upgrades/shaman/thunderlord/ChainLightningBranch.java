...
public class ChainLightningBranch extends AbstractUpgradeBranch<ChainLightning> {
    ...
    public ChainLightningBranch(AbilityTree abilityTree, ChainLightning ability) {
        ...
        masterUpgrade = new Upgrade(
                ...
                50000,
                () -> {
                    ability.getDamageDecreasePerBounce().addModifier(FloatModifiable.ModifierType.MULTIPLICATIVE_MULTIPLIER, "Master Upgrade Branch", -1);
        ...
        masterUpgrade2 = new Upgrade(
                ...
                "Chain Lightning - Master Upgrade",
                """
                        Chain Lightning will now give enemies hit the SHOCKED status for 5s.
                        
                        SHOCKED: Enemies that are shocked take 20% more damage from the caster and reduces the caster's ultimate ability cooldown by 0.5s if killed by the caster.
                        """,
                50000,
                () -> {
                }
