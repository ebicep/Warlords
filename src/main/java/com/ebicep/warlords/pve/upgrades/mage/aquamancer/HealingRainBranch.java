    ...
    public HealingRainBranch(AbilityTree abilityTree, HealingRain ability) {
        ...
        masterUpgrade = new Upgrade(
                ...
                """
                        ...
                        Up to 8 enemies in Healing Rain will be struck with lightning for 224 - 377 (+100% of MAX HEALTH DAMAGE) damage every 2 seconds.""",
                50000,
                () -> {
        ...
        masterUpgrade2 = new Upgrade(
                ...
                "Healing Rain - Master Upgrade",
                """
                        Allies within the radius of Healing Rain are instead, granted a personal rain cloud that heals the same as the original, additionally increases EPS by 5 for the duration. The single clouds can follow allies up to 40 blocks away from you.
                        """,
                50000,
                () -> {
                }
