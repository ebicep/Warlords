...
public class BeaconOfImpairBranch extends AbstractUpgradeBranch<BeaconOfImpair> {

    public BeaconOfImpairBranch(AbilityTree abilityTree, BeaconOfImpair ability) {
