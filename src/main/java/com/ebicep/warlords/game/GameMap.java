...
public abstract class GameMap {
    ...
    public static final GameMap DEBUG = new Debug();
    ...
    public static final GameMap HEAVEN_WILL = new HeavenWill();
    ...
    public static final GameMap ILLUSION_RIFT_EVENT_1 = new IllusionRiftEvent1();
    public static final GameMap ILLUSION_RIFT_EVENT_2 = new IllusionRiftEvent2();
    public static final GameMap ILLUSION_RIFT_EVENT_3 = new IllusionRiftEvent3();
    public static final GameMap ILLUSION_RIFT_EVENT_4 = new IllusionRiftEvent4();
    public static final GameMap ILLUSION_RIFT_EVENT_5 = new IllusionRiftEvent5();
    public static final GameMap ILLUSION_VALLEY = new IllusionValley();
    public static final GameMap ILLUSION_VALLEY2 = new IllusionValley2();
    ...
    public static final GameMap RIFT = new Rift();
    ...
    public static final GameMap TUTORIAL_MAP = new TutorialMap();
