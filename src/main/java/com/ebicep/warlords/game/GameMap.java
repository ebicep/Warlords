    ...
    ILLUSION_RIFT(
        ...
        public List<Option> initMap(GameMode category, LocationFactory loc, EnumSet<GameAddon> addons) {
            ...
            options.add(new WaveDefenseOption(Team.RED, new StaticWaveList()
                    ...
                    .add(15, new SimpleWave(15, 10 * SECOND, null)
                            //basic
                    ...
                    .add(35, new SimpleWave(25, 10 * SECOND, null)
                            //basic
                    ...
                    .add(45, new SimpleWave(30, 10 * SECOND, null)
                            ...
                            .add(0.01, Mobs.ENVOY_PIG_ZOMBIE)
                            .add(0.03, Mobs.ENVOY_BERSERKER_ZOMBIE)
                            //elite
                    ...
                    .add(51, new SimpleWave(32, 10 * SECOND, null)
                            //basic
                            ...
                            //envoy
                            .add(0.08, Mobs.ENVOY_ZOMBIE)
                            .add(0.08, Mobs.ENVOY_SKELETON)
                            .add(0.08, Mobs.ENVOY_PIG_ZOMBIE)
                            //elite
                    ...
                    .add(61, new SimpleWave(35, 10 * SECOND, null)
                            //basic
                            .add(0, Mobs.BASIC_ZOMBIE)
                            .add(0, Mobs.BASIC_SKELETON)
                            .add(0, Mobs.BASIC_PIG_ZOMBIE)
                    ...
                    .add(71, new SimpleWave(38, 10 * SECOND, null)
                            //basic
                            .add(0, Mobs.BASIC_ZOMBIE)
                            .add(0, Mobs.BASIC_SKELETON)
                            .add(0, Mobs.BASIC_PIG_ZOMBIE)
                    ...
                    .add(81, new SimpleWave(40, 10 * SECOND, null)
                            //basic
                            .add(0, Mobs.BASIC_ZOMBIE)
                            .add(0, Mobs.BASIC_SKELETON)
                            .add(0, Mobs.BASIC_PIG_ZOMBIE)
                    ...
                    .add(91, new SimpleWave(42, 10 * SECOND, null)
                            //basic
                            .add(0, Mobs.BASIC_ZOMBIE)
                            .add(0, Mobs.BASIC_SKELETON)
                            .add(0, Mobs.BASIC_PIG_ZOMBIE)
                    ...
                    .add(101, new SimpleWave(45, 10 * SECOND, null)
                            //basic
                            .add(0.25, Mobs.BASIC_ZOMBIE)
                            .add(0.25, Mobs.BASIC_SKELETON)
                            .add(0.25, Mobs.BASIC_PIG_ZOMBIE)
                            .add(0.25, Mobs.BASIC_SLIME)
                            .add(0.25, Mobs.SPIDER)
                            .add(0.25, Mobs.WOLF)
                            ...
                            .add(0.5, Mobs.ELITE_SKELETON)
                            .add(0.5, Mobs.ELITE_PIG_ZOMBIE)
                            .add(0.5, Mobs.MAGMA_CUBE)
                            .add(0.5, Mobs.IRON_GOLEM)
                            //envoy
                            .add(0.5, Mobs.ENVOY_ZOMBIE)
                            .add(0.5, Mobs.ENVOY_SKELETON)
                            .add(0.5, Mobs.ENVOY_PIG_ZOMBIE)
                    ),
                    50
            ));
        ...
        public List<Option> initMap(GameMode category, LocationFactory loc, EnumSet<GameAddon> addons) {
            ...
            options.add(new WaveDefenseOption(Team.RED, new StaticWaveList()
                    ...
                    .add(31, new SimpleWave(22, 10 * SECOND, null)
                            ...
                            .add(0.25, Mobs.ELITE_ZOMBIE)
                            .add(0.1, Mobs.ELITE_SKELETON)
                            .add(0.15, Mobs.ELITE_PIG_ZOMBIE)
                            .add(0.02, Mobs.MAGMA_CUBE)
                            .add(0.05, Mobs.IRON_GOLEM)
                            //envoy
                            .add(0.02, Mobs.ENVOY_ZOMBIE)
