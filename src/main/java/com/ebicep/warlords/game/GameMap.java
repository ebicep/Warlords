    ...
    ILLUSION_CROSSFIRE(
        ...
        public List<Option> initMap(GameMode category, LocationFactory loc, EnumSet<GameAddon> addons) {
            ...
            options.add(new WaveDefenseOption(Team.RED, new StaticWaveList()
                    ...
                    .add(10, new SimpleWave(17, 10 * SECOND, null)
                            //basic
                            .add(0.8, Mobs.BASIC_ZOMBIE)
                            .add(0.1, Mobs.BASIC_SKELETON)
                            .add(0, Mobs.BASIC_PIG_ZOMBIE)
                    ...
                    .add(15, new SimpleWave(18, 10 * SECOND, null)
                            //basic
                            .add(0.75, Mobs.BASIC_ZOMBIE)
                            .add(0.12, Mobs.BASIC_SKELETON)
                            .add(0, Mobs.BASIC_PIG_ZOMBIE)
                            .add(0.06, Mobs.BASIC_SLIME)
                            .add(0.06, Mobs.SPIDER)
                            .add(0.06, Mobs.WOLF)
                    ...
                    .add(21, new SimpleWave(20, 10 * SECOND, null)
                            ...
                            //elite
                            .add(0.2, Mobs.ELITE_ZOMBIE)
                            .add(0.06, Mobs.ELITE_SKELETON)
                            .add(0.02, Mobs.ELITE_PIG_ZOMBIE)
                            .add(0.04, Mobs.MAGMA_CUBE)
                            .add(0.04, Mobs.IRON_GOLEM)
                            .add(0.04, Mobs.BLAZE)
                            .add(0.04, Mobs.WITCH)
                            //envoy
                            .add(0.01, Mobs.ENVOY_ZOMBIE)
                            .add(0.01, Mobs.ENVOY_SKELETON)
                            .add(0, Mobs.ENVOY_PIG_ZOMBIE)
                            //elite
                    ...
                    .add(25, new SimpleWave(22, 10 * SECOND, null)
                            //basic
                            .add(0.65, Mobs.BASIC_ZOMBIE)
                            .add(0.12, Mobs.BASIC_SKELETON)
                            .add(0, Mobs.BASIC_PIG_ZOMBIE)
                            .add(0.06, Mobs.BASIC_SLIME)
                            .add(0.06, Mobs.SPIDER)
                    ...
                    .add(25, new SimpleWave(24, 10 * SECOND, null)
                            //basic
                            .add(0.5, Mobs.BASIC_ZOMBIE)
                            .add(0.12, Mobs.BASIC_SKELETON)
                            .add(0, Mobs.BASIC_PIG_ZOMBIE)
                            ...
                            //elite
                            .add(0.3, Mobs.ELITE_ZOMBIE)
                            .add(0.08, Mobs.ELITE_SKELETON)
                            .add(0.02, Mobs.ELITE_PIG_ZOMBIE)
                            .add(0.04, Mobs.MAGMA_CUBE)
                            .add(0.08, Mobs.IRON_GOLEM)
                            .add(0.07, Mobs.BLAZE)
                            .add(0.04, Mobs.WITCH)
                            //envoy
                            .add(0.02, Mobs.ENVOY_ZOMBIE)
                    ...
                    .add(30, new SimpleWave(26, 10 * SECOND, null)
                            //basic
                            .add(0.4, Mobs.BASIC_ZOMBIE)
                            .add(0.15, Mobs.BASIC_SKELETON)
                            .add(0, Mobs.BASIC_PIG_ZOMBIE)
                            .add(0.06, Mobs.BASIC_SLIME)
                            .add(0.06, Mobs.SPIDER)
                            .add(0.06, Mobs.WOLF)
                            ...
                            .add(0.35, Mobs.ELITE_ZOMBIE)
                            .add(0.08, Mobs.ELITE_SKELETON)
                            .add(0.03, Mobs.ELITE_PIG_ZOMBIE)
                            .add(0.05, Mobs.MAGMA_CUBE)
                            .add(0.08, Mobs.IRON_GOLEM)
                            .add(0.1, Mobs.BLAZE)
                            .add(0.04, Mobs.WITCH)
                            //envoy
                    ...
                    .add(35, new SimpleWave(28, 10 * SECOND, null)
                            //basic
                    ...
                    .add(41, new SimpleWave(30, 10 * SECOND, null)
                            //basic
                            .add(0.25, Mobs.BASIC_ZOMBIE)
                            .add(0.05, Mobs.BASIC_SKELETON)
                            .add(0, Mobs.BASIC_PIG_ZOMBIE)
                            .add(0.06, Mobs.BASIC_SLIME)
                            .add(0.06, Mobs.SPIDER)
                    ...
                    .add(45, new SimpleWave(32, 10 * SECOND, null)
                            //basic
                            ...
                            //elite
                            .add(0.07, Mobs.VOID_ZOMBIE)
                            .add(0.07, Mobs.VOID_SKELETON)
                            .add(0.07, Mobs.EXILED_ZOMBIE_LAVA)
                            .add(0.07, Mobs.EXILED_ZOMBIE_RIFT)
                    )
                    .add(50, new SimpleWave(34, 10 * SECOND, null)
                            //basic
                            .add(0.15, Mobs.BASIC_ZOMBIE)
                            .add(0.03, Mobs.BASIC_SKELETON)
                            .add(0, Mobs.BASIC_PIG_ZOMBIE)
                            .add(0.06, Mobs.BASIC_SLIME)
                            ...
                            .add(0.05, Mobs.ENVOY_PIG_ZOMBIE)
                            //elite
                            .add(0.09, Mobs.VOID_ZOMBIE)
                            .add(0.09, Mobs.VOID_SKELETON)
                            .add(0.09, Mobs.EXILED_ZOMBIE_LAVA)
                            .add(0.09, Mobs.EXILED_ZOMBIE_RIFT)
                    )
                    .add(55, new SimpleWave(36, 10 * SECOND, null)
                            //basic
                            ...
                            .add(0.05, Mobs.ENVOY_PIG_ZOMBIE)
                            //elite
                            .add(0.11, Mobs.VOID_ZOMBIE)
                            .add(0.11, Mobs.VOID_SKELETON)
                            .add(0.11, Mobs.EXILED_ZOMBIE_LAVA)
                            .add(0.11, Mobs.EXILED_ZOMBIE_RIFT)
                    )
                    .add(60, new SimpleWave(1, 10 * SECOND, "Boss", MobTier.BOSS)
                            .add(Mobs.NARMER)
                    )
                    .add(65, new SimpleWave(40, 10 * SECOND, null)
                            //basic
                            .add(0.1, Mobs.BASIC_ZOMBIE)
                            .add(0.03, Mobs.BASIC_SKELETON)
                            .add(0, Mobs.BASIC_PIG_ZOMBIE)
                    ...
                    .add(70, new SimpleWave(42, 10 * SECOND, null)
                            //basic
                            .add(0.1, Mobs.BASIC_ZOMBIE)
                            .add(0.03, Mobs.BASIC_SKELETON)
                            .add(0, Mobs.BASIC_PIG_ZOMBIE)
                            ...
                            .add(0.05, Mobs.ENVOY_PIG_ZOMBIE)
                            //elite
                            .add(0.13, Mobs.VOID_ZOMBIE)
                            .add(0.13, Mobs.VOID_SKELETON)
                            .add(0.13, Mobs.EXILED_ZOMBIE_LAVA)
                            .add(0.13, Mobs.EXILED_ZOMBIE_RIFT)
                    )
                    .add(75, new SimpleWave(44, 10 * SECOND, null)
                            //basic
                            .add(0.02, Mobs.BASIC_ZOMBIE)
                            .add(0.03, Mobs.BASIC_SKELETON)
                            .add(0, Mobs.BASIC_PIG_ZOMBIE)
                            .add(0.1, Mobs.BASIC_SLIME)
                            .add(0.08, Mobs.SPIDER)
                            ...
                            .add(0.05, Mobs.ENVOY_PIG_ZOMBIE)
                            //elite
                            .add(0.15, Mobs.VOID_ZOMBIE)
                            .add(0.15, Mobs.VOID_SKELETON)
                            .add(0.15, Mobs.EXILED_ZOMBIE_LAVA)
                            .add(0.15, Mobs.EXILED_ZOMBIE_RIFT)
                    )
                    .add(80, new SimpleWave(2, 10 * SECOND, "Boss", MobTier.BOSS)
                            .add(Mobs.MITHRA)
                    )
                    .add(81, new SimpleWave(47, 10 * SECOND, null)
                            //basic
                            ...
                            //envoy
                            .add(0.1, Mobs.ENVOY_ZOMBIE)
                            .add(0.07, Mobs.ENVOY_SKELETON)
                            .add(0.07, Mobs.ENVOY_PIG_ZOMBIE)
                            //elite
                            .add(0.18, Mobs.ENVOY_BERSERKER_ZOMBIE)
                            .add(0.18, Mobs.VOID_ZOMBIE)
                            .add(0.18, Mobs.VOID_SKELETON)
                            .add(0.18, Mobs.EXILED_ZOMBIE_LAVA)
                            .add(0.18, Mobs.EXILED_ZOMBIE_RIFT)
                    )
                    .add(85, new SimpleWave(50, 10 * SECOND, null)
                            //basic
                            .add(0, Mobs.BASIC_ZOMBIE)
                            .add(0.03, Mobs.BASIC_SKELETON)
                            .add(0, Mobs.BASIC_PIG_ZOMBIE)
                    ...
                    .add(90, new SimpleWave(52, 10 * SECOND, null)
                            //basic
                            .add(0, Mobs.BASIC_ZOMBIE)
                            .add(0.03, Mobs.BASIC_SKELETON)
                            .add(0, Mobs.BASIC_PIG_ZOMBIE)
                            ...
                            .add(0.07, Mobs.ENVOY_PIG_ZOMBIE)
                            //elite
                            .add(0.22, Mobs.ENVOY_BERSERKER_ZOMBIE)
                            .add(0.22, Mobs.VOID_ZOMBIE)
                            .add(0.22, Mobs.VOID_SKELETON)
                            .add(0.22, Mobs.EXILED_ZOMBIE_LAVA)
                            .add(0.22, Mobs.EXILED_ZOMBIE_RIFT)
                    )
                    .add(95, new SimpleWave(56, 10 * SECOND, null)
                            //basic
                            .add(0, Mobs.BASIC_ZOMBIE)
                            .add(0, Mobs.BASIC_SKELETON)
                            .add(0, Mobs.BASIC_PIG_ZOMBIE)
                            ...
                            .add(1, Mobs.ELITE_ZOMBIE)
                            .add(0.15, Mobs.ELITE_SKELETON)
                            .add(0.07, Mobs.ELITE_PIG_ZOMBIE)
                            .add(0.08, Mobs.MAGMA_CUBE)
                            .add(0.12, Mobs.IRON_GOLEM)
                            .add(0.12, Mobs.BLAZE)
                            .add(0.1, Mobs.WITCH)
                    ...
                    .add(101, new SimpleWave(60, 10 * SECOND, null)
                            //basic
                            .add(0, Mobs.BASIC_ZOMBIE)
                            .add(0.03, Mobs.BASIC_SKELETON)
                            .add(0, Mobs.BASIC_PIG_ZOMBIE)
                            ...
                            //elite
                            .add(0.4, Mobs.ENVOY_BERSERKER_ZOMBIE)
                            .add(0.4, Mobs.VOID_ZOMBIE)
                            .add(0.4, Mobs.VOID_SKELETON)
                            .add(0.4, Mobs.EXILED_ZOMBIE_LAVA)
                            .add(0.4, Mobs.EXILED_ZOMBIE_RIFT)
                    ),
