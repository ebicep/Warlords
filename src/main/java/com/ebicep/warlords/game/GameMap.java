...
public enum GameMap {
    ...
    ILLUSION_RIFT_EVENT_4(
        ...
        public List<Option> initMap(GameMode category, LocationFactory loc, EnumSet<GameAddon> addons) {
            ...
            options.add(new WaveDefenseOption(Team.RED, new StaticWaveList()
                    .add(1, new SimpleWave(8, 0, null)
                            .add(0.4, Mobs.BASIC_ZOMBIE)
                            .add(0.5, Mobs.BASIC_PIG_ZOMBIE)
                            .add(0.1, Mobs.GHOST_ZOMBIE)
                    )
                    .add(2, new SimpleWave(8, 0, null)
                            .add(0.4, Mobs.BASIC_ZOMBIE)
                            .add(0.4, Mobs.BASIC_PIG_ZOMBIE)
                            .add(0.1, Mobs.SPIDER)
                            .add(0.1, Mobs.GHOST_ZOMBIE)
                    )
                    .add(4, new SimpleWave(8, 0, null)
                            .add(0.4, Mobs.BASIC_ZOMBIE)
                            .add(0.3, Mobs.BASIC_PIG_ZOMBIE)
                            .add(0.1, Mobs.SPIDER)
                            .add(0.1, Mobs.GHOST_ZOMBIE)
                    ...
                    .add(5, new SimpleWave(8, 0, "Boss", MobTier.BOSS)
                    ...
                    .add(6, new SimpleWave(12, 0, null)
                            .add(0.4, Mobs.BASIC_ZOMBIE)
                            .add(0.3, Mobs.BASIC_PIG_ZOMBIE)
                            .add(0.1, Mobs.SPIDER)
                            .add(0.1, Mobs.GHOST_ZOMBIE)
                    ...
                    .add(8, new SimpleWave(12, 0, null)
                            .add(0.2, Mobs.BASIC_ZOMBIE)
                            .add(0.2, Mobs.BASIC_PIG_ZOMBIE)
                            .add(0.2, Mobs.SPIDER)
                            .add(0.1, Mobs.GHOST_ZOMBIE)
                    ...
                    .add(10, new SimpleWave(12, 0, "Boss", MobTier.BOSS)
                    ...
                    .add(11, new SimpleWave(16, 0, null)
                            .add(0.1, Mobs.BASIC_ZOMBIE)
                            .add(0.1, Mobs.BASIC_PIG_ZOMBIE)
                            .add(0.1, Mobs.GHOST_ZOMBIE)
                            .add(0.1, Mobs.SPIDER)
                    ...
                    .add(13, new SimpleWave(16, 0, null)
                            .add(0.1, Mobs.BASIC_ZOMBIE)
                            .add(0.1, Mobs.BASIC_PIG_ZOMBIE)
                            .add(0.1, Mobs.GHOST_ZOMBIE)
                            .add(0.2, Mobs.SPIDER)
                    ...
                    .add(16, new SimpleWave(20, 0, null)
                            .add(0.2, Mobs.BASIC_PIG_ZOMBIE)
                            .add(0.1, Mobs.GHOST_ZOMBIE)
                            .add(0.1, Mobs.SPIDER)
                            .add(0.2, Mobs.ELITE_PIG_ZOMBIE)
                    ...
                    .add(20, new SimpleWave(20, 0, "Boss", MobTier.BOSS)
                            .add(0.1, Mobs.EVENT_MITHRA_FORSAKEN_FROST)
                            .add(0.1, Mobs.EVENT_MITHRA_FORSAKEN_FOLIAGE)
                            .add(0.1, Mobs.EVENT_MITHRA_FORSAKEN_SHRIEKER)
                    ...
                    .add(21, new SimpleWave(24, 0, null)
                            .add(0.1, Mobs.BASIC_ZOMBIE)
                            .add(0.1, Mobs.BASIC_PIG_ZOMBIE)
                            .add(0.1, Mobs.GHOST_ZOMBIE)
                            .add(0.1, Mobs.SPIDER)
