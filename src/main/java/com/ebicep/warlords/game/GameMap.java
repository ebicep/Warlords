...
public enum GameMap {
    ...
    ILLUSION_APERTURE(
        ...
        public List<Option> initMap(GameMode category, LocationFactory loc, EnumSet<GameAddon> addons) {
            ...
            options.add(new CurrencyOnEventOption(500));
            options.add(new WaveDefenseOption(Team.RED, new StaticWaveList()
                    .add(1, new SimpleWave(9, 10 * SECOND, null)
                            //basic
                            .add(0.9, Mobs.BASIC_ZOMBIE)
    ...
    ILLUSION_CROSSFIRE(
        ...
        public List<Option> initMap(GameMode category, LocationFactory loc, EnumSet<GameAddon> addons) {
            ...
            options.add(new WaveDefenseOption(Team.RED, new StaticWaveList()
                    ...
                    .add(31, new SimpleWave(26, 10 * SECOND, null)
                            //basic
                            .add(0.4, Mobs.BASIC_ZOMBIE)
                    ...
                    .add(51, new SimpleWave(36, 10 * SECOND, null)
                            //basic
                    ...
                    .add(55, new SimpleWave(38, 10 * SECOND, null)
                            ...
                            .add(0.05, Mobs.ENVOY_PIG_ZOMBIE)
                            //elite
                            .add(0.12, Mobs.ENVOY_BERSERKER_ZOMBIE)
                    ...
                    .add(61, new SimpleWave(40, 10 * SECOND, null)
                            //basic
                            .add(0, Mobs.BASIC_ZOMBIE)
                    ...
                    .add(65, new SimpleWave(42, 10 * SECOND, null)
                            //basic
                            .add(0, Mobs.BASIC_ZOMBIE)
                            .add(0, Mobs.BASIC_SKELETON)
                            .add(0, Mobs.BASIC_PIG_ZOMBIE)
                            ...
                            .add(0.05, Mobs.ENVOY_PIG_ZOMBIE)
                            //elite
                            .add(0.14, Mobs.VOID_ZOMBIE)
                            .add(0.14, Mobs.VOID_SKELETON)
                            .add(0.14, Mobs.EXILED_ZOMBIE_LAVA)
                            .add(0.14, Mobs.EXILED_ZOMBIE_RIFT)
                    )
                    .add(70, new SimpleWave(1, 10 * SECOND, "Boss", MobTier.BOSS)
                            .add(Mobs.GHOULCALLER)
                    )
                    .add(71, new SimpleWave(44, 10 * SECOND, null)
                            //basic
                    ...
                    .add(91, new SimpleWave(56, 10 * SECOND, null)
                            //basic
                            .add(0, Mobs.BASIC_ZOMBIE)
                            .add(0, Mobs.BASIC_SKELETON)
                            .add(0, Mobs.BASIC_PIG_ZOMBIE)
