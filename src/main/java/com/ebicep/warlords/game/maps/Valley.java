...
public class Valley extends GameMap {
    ...
    public List<Option> initMap(GameMode category, LocationFactory loc, EnumSet<GameAddon> addons) {
        ...
        options.add(new PowerupOption(loc.addXYZ(2.5, 26, -103.5), PowerupOption.PowerUp.SPEED));
        options.add(new PowerupOption(loc.addXYZ(-1.5, 26, 104.5), PowerupOption.PowerUp.SPEED));
