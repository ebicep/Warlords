...
public class IllusionCrossfire extends GameMap {
    ...
    public List<Option> initMap(GameMode category, LocationFactory loc, EnumSet<GameAddon> addons) {
        ...
        options.add(new WaveDefenseOption(Team.RED, new StaticWaveList()
                ...
                .add(110, new RandomSpawnWave(3, 10 * SECOND, Component.text("Boss"))
                        .add(Mob.BOLTARO)
                )
                ...
                .add(120, new RandomSpawnWave(3, 10 * SECOND, Component.text("Boss"))
                        .add(Mob.GHOULCALLER)
                )
                ...
                .add(130, new RandomSpawnWave(3, 10 * SECOND, Component.text("Boss"))
                        .add(Mob.NARMER)
                )
                .add(131, new RandomSpawnWave(50, 5 * SECOND, null)
                        .add(0.04, Mob.ILLUMINATION)
                        .add(0.06, Mob.GOLEM_APPRENTICE)
                        .add(0.05, Mob.WITCH_DEACON)
                        .add(0.02, Mob.SLIMY_CHESS)
                ...
                .add(140, new RandomSpawnWave(3, 10 * SECOND, Component.text("Boss"))
                        .add(Mob.MITHRA)
                )
                .add(141, new RandomSpawnWave(55, 5 * SECOND, null)
                        .add(0.04, Mob.ILLUMINATION)
                        .add(0.06, Mob.GOLEM_APPRENTICE)
                        .add(0.05, Mob.WITCH_DEACON)
                        .add(0.02, Mob.SLIMY_CHESS)
                ...
                .add(150, new RandomSpawnWave(3, 10 * SECOND, Component.text("Boss"))
                        .add(Mob.ZENITH)
                )
                .add(151, new RandomSpawnWave(60, 5 * SECOND, null)
                        .add(0.04, Mob.ILLUMINATION)
                        .add(0.06, Mob.GOLEM_APPRENTICE)
                        .add(0.05, Mob.WITCH_DEACON)
                        .add(0.02, Mob.SLIMY_CHESS)
                ...
                .add(160, new RandomSpawnWave(3, 10 * SECOND, Component.text("Boss"))
                        .add(Mob.ILLUMINA)
                )
                .add(161, new RandomSpawnWave(65, 5 * SECOND, null)
                        .add(0.04, Mob.ILLUMINATION)
                        .add(0.06, Mob.GOLEM_APPRENTICE)
                        .add(0.05, Mob.WITCH_DEACON)
                        .add(0.02, Mob.SLIMY_CHESS)
