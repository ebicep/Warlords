...
public class IllusionCrossfire extends GameMap {
    ...
    public List<Option> initMap(GameMode category, LocationFactory loc, EnumSet<GameAddon> addons) {
        ...
        options.add(new WaveDefenseOption(Team.RED, new StaticWaveList()
                ...
                .add(111, new RandomSpawnWave(10, 10 * SECOND, Component.text("Boss"))
                        .add(Mob.BOLTARO)
                )
                .add(112, new RandomSpawnWave(10, 10 * SECOND, Component.text("Boss"))
                        .add(Mob.GHOULCALLER)
                )
                .add(113, new RandomSpawnWave(10, 10 * SECOND, Component.text("Boss"))
                        .add(Mob.NARMER)
                )
                .add(114, new RandomSpawnWave(200, 10 * SECOND, null)
                        .add(1, Mob.RIFT_WALKER)
                )
