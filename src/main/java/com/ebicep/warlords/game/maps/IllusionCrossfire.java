...
public class IllusionCrossfire extends GameMap {
    ...
    public List<Option> initMap(GameMode category, LocationFactory loc, EnumSet<GameAddon> addons) {
        ...
        options.add(new WaveDefenseOption(Team.RED, new StaticWaveList()
                ...
                .add(119, new RandomSpawnWave(5, 10 * SECOND, Component.text("Boss"))
                        .add(Mob.TORMENT)
                )
                .add(120, new RandomSpawnWave(5, 10 * SECOND, Component.text("Boss"))
                        .add(Mob.ONE_OF_NINE)
                )
                //next update
...
//                )
//                // bosses repeat
//                .add(121, new RandomSpawnWave(5, 10 * SECOND, Component.text("Boss"))
//                        .add(Mob.BOLTARO)
//                )
//                .add(122, new RandomSpawnWave(5, 10 * SECOND, Component.text("Boss"))
//                        .add(Mob.GHOULCALLER)
//                )
//                .add(123, new RandomSpawnWave(5, 10 * SECOND, Component.text("Boss"))
//                        .add(Mob.NARMER)
//                )
//                .add(124, new RandomSpawnWave(5, 10 * SECOND, Component.text("Boss"))
//                        .add(Mob.MITHRA)
//                )
//                .add(125, new RandomSpawnWave(5, 10 * SECOND, Component.text("Boss"))
//                        .add(Mob.ZENITH)
//                )
//                .add(126, new RandomSpawnWave(5, 10 * SECOND, Component.text("Boss"))
//                        .add(Mob.MAGMATIC_OOZE)
//                )
//                .add(127, new RandomSpawnWave(5, 10 * SECOND, Component.text("Boss"))
//                        .add(Mob.ILLUMINA)
//                )
//                .add(128, new RandomSpawnWave(5, 10 * SECOND, Component.text("Boss"))
//                        .add(Mob.VOID)
//                )
//                .add(129, new RandomSpawnWave(5, 10 * SECOND, Component.text("Boss"))
//                        .add(Mob.TORMENT)
//                )
//                // hard-lock
