...
public class WhatOnceWas extends AbstractAnomalyMap {
    ...
    private static final double[][][] RUNE_LOCATIONS = {
            {{14.5, 90, 14.5}, {18.5, 90, 14.5}, {14.5, 90, 18.5}, {18.5, 90, 18.5}},
            {{-17.5, 90, 14.5}, {-13.5, 90, 14.5}, {-17.5, 90, 18.5}, {-13.5, 90, 18.5}},
            {{-1.5, 90, -21.5}, {2.5, 90, -21.5}, {-1.5, 90, -17.5}, {2.5, 90, -17.5}}
    };
    private static final double[][][] ENEMY_SPAWN_LOCATIONS = {
            {{25.5, 90, 25.5}, {25.5, 90, 14.5}, {14.5, 90, 25.5}},
            {{-25.5, 90, 25.5}, {-25.5, 90, 14.5}, {-13.5, 90, 25.5}},
            {{0.5, 90, -25.5}, {16.5, 90, -26.5}, {-15.5, 90, -25.5}}
    };
