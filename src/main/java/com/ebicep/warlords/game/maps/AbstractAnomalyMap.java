...
public abstract class AbstractAnomalyMap extends GameMap {
    ...
    protected AbstractAnomalyMap(String mapName, String fileName, double[] playerSpawn) {
        super(mapName, 6, 2, 30 * SECOND, fileName, 5, GameMode.ANOMALY);
    ...
    public List<Option> initMap(GameMode category, LocationFactory loc, EnumSet<GameAddon> addons) {
        ...
        options.add(new BoundingBoxOption(new Location(loc.getWorld(), -1024, 0, -1024), new Location(loc.getWorld(), 1024, 319, 1024)));
