...
public class IllusionBasin extends GameMap {

    public IllusionBasin() {
        super(
                "Illusion Basin",
                4,
                1,
    ...
    public List<Option> initMap(GameMode category, LocationFactory loc, EnumSet<GameAddon> addons) {
        ...
        options.add(new WaveDefenseOption(Team.RED, new StaticWaveList()
                ...
                .add(16, new RandomSpawnWave(20, 10 * SECOND, null)
                        ...
                        .add(0.02, Mob.NIGHTMARE_ZOMBIE)
                        .add(0.04, Mob.EXTREME_ZEALOT)
                        .add(0.01, Mob.ZOMBIE_END)
                        .add(0.06, Mob.CELESTIAL_OPUS)
                        .add(0.04, Mob.ZOMBIE_KNIGHT)
                        .add(0.04, Mob.RIFT_WALKER)
                        .add(0.02, Mob.ENDERMAN_ANOMALY)
                        .add(0.02, Mob.WANDER_WALKER)
                        .add(0.02, Mob.ZOMBIE_RAIDER)
                        .add(0.01, Mob.LANTERN_DREDGER)
                        .add(0.01, Mob.ABYSS_WATCHER)
                        .add(0.001, Mob.SILTSTALKER)
                )
