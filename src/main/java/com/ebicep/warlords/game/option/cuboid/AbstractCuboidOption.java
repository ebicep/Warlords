...
public abstract class AbstractCuboidOption implements Option {
    ...
    public static final int MAX_WORLD_SIZE_MINI = 200;
    ...
    public AbstractCuboidOption(World world, int maxSize) {
        this(
                new Location(world, -maxSize, -256, -maxSize),
                new Location(world, maxSize, 512, maxSize)
        );
    }
    ...
    public AbstractCuboidOption(Location a, Location b) {
        ...
        this.min = new Location(a.getWorld(),
        ...
        this.max = new Location(a.getWorld(),
