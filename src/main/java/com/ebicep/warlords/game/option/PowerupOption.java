...
public class PowerupOption implements Option {
    ...
    public enum PowerupType {
        SPEED(10, Material.WOOL, (short) 4) {
            @Override
            public void onPickUp(PowerupOption option, AbstractWarlordsEntity warlordsPlayer) {
        ...
        public abstract void onPickUp(PowerupOption option, AbstractWarlordsEntity warlordsPlayer);
