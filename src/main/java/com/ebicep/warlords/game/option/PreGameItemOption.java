...
public class PreGameItemOption implements Option {
    ...
    public void setItem(@Nonnull BiFunction<Game, Player, ItemStack> item) {
        this.item = item;
    }

    public @org.jetbrains.annotations.Nullable BiConsumer<Game, Player> getOnClick() {
        return onClick;
    }

    public void setOnClick(@org.jetbrains.annotations.Nullable BiConsumer<Game, Player> onClick) {
        this.onClick = onClick;
    }
