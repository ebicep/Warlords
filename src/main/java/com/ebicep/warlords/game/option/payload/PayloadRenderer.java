...
public class PayloadRenderer {
    ...
    public void move(Location c) {
        LocationBuilder center = new LocationBuilder(c).addY(-.6);
    ...
    public void playEffects(int ticksElapsed, Location center, double radius) {
        if (circleEffect == null) {
            circleEffect = new CircleEffect(game, null, center, radius, new CircumferenceEffect(Particle.CRIT));
        }
