...
public enum HonorificFont {
    ...
    STANDARD("Standard", Material.PAPER, false, false, false),
    BOLD("Bold", Material.ANVIL, true, false, false),
    ITALIC("Italic", Material.FEATHER, false, true, false),
    SMALL_CAPS("Small Caps", Material.WRITABLE_BOOK, false, false, true);
    ...
    HonorificFont(String displayName, Material icon, boolean bold, boolean italic, boolean smallCaps) {
