...
public enum Honorific {
    ...
    GOLDEN("Golden", "Purchased from The Artificer.", Material.GOLD_INGOT, HonorificCost.of(Currencies.COIN, 50_000_000)),
    PROSPEROUS("Prosperous", "Purchased from The Artificer.", Material.GOLDEN_BOOTS, HonorificCost.of(Currencies.COIN, 250_000_000)),
    ...
    LEGEND("Legend", "Purchased from The Artificer.", Material.BLAZE_POWDER, HonorificCost.of(Currencies.LEGEND_FRAGMENTS, 400_000)),
    ...
    SYNTHETIC("Synthetic", "Purchased from The Artificer.", Material.AMETHYST_SHARD, HonorificCost.of(Currencies.SYNTHETIC_SHARD, 500_000)),
    STAR_GUIDE("Star Guide", "Use 500 Star Pieces.", Material.NETHER_STAR, null),
    HARMONIOUS("Harmonious", "Purchased from The Artificer.", Material.MAGENTA_DYE, HonorificCost.of(Currencies.FAIRY_ESSENCE, 200_000)),
    SUPPLIER("Supplier", "Roll 50,000 Supply Drop Tokens.", Material.FIREWORK_STAR, null),
    CHARM_OF_ZENITH("Charm of Zenith", "Purchased from The Artificer.", Material.WIND_CHARGE, HonorificCost.of(MobDrop.ZENITH_STAR, 500)),
    LIMITLESS("Limitless", "Purchased from The Artificer.", Material.CLOCK, HonorificCost.of(Currencies.LIMIT_BREAKER, 400)),
