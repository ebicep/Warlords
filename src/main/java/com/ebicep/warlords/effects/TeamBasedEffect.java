...
public class TeamBasedEffect {
    ...
    public void display(GameTeamContainer teams, float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center) {
        ownTeam.display(offsetX, offsetY, offsetZ, speed, amount, center, teams.getAllyPlayers().toList());
        enemyTeam.display(offsetX, offsetY, offsetZ, speed, amount, center, teams.getEnemyPlayers().toList());
    }

    public void display(GameTeamContainer teams, Vector direction, float speed, Location center) {
        ownTeam.display(direction, speed, center, teams.getAllyPlayers().toList());
        enemyTeam.display(direction, speed, center, teams.getEnemyPlayers().toList());
    }
