...
public class Haze extends AbstractAbility implements OrangeAbilityIcon, Damages<Haze.DamageValues>, AbilityStats<Haze, Haze.VanishStats>, OrderOfEviscerateLike {
    ...
    public void updateDescription(Player player) {
        description = AbilityDescriptionBuilder
                ...
                .text(" extra speed, reducing incoming damage by ")
                ...
                .text(". Judgement Strike and melee attacks will end the ability.")
                .emptyLine()
                .text("When Haze expires, all nearby enemies will be marked as Vulnerable, taking ")
