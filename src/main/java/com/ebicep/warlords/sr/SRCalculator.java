...
public class SRCalculator {
    ...
    public static void recalculateSR() {
        ...
        Collection<DatabasePlayer> players = DatabaseManager.CACHED_PLAYERS.getOrDefault(PlayersCollections.SEASON_11,
...
//                    });
    ...
    private static double getPlayerTotal(Function<DatabasePlayer, Double> function) {
        ...
        double total = DatabaseManager.CACHED_PLAYERS.getOrDefault(PlayersCollections.SEASON_11, new ConcurrentHashMap<>()).values()
                                                     .stream()
