...
public class SRCalculator {
    ...
    public static void recalculateSR() {
        ...
        Collection<DatabasePlayer> players = DatabaseManager.CACHED_PLAYERS.getOrDefault(PlayersCollections.SEASON_12,
...
//                    });
    ...
    private static double getPlayerTotal(Function<DatabasePlayer, Double> function) {
        ...
        double total = DatabaseManager.CACHED_PLAYERS.getOrDefault(PlayersCollections.SEASON_12, new ConcurrentHashMap<>()).values()
                                                     .stream()
