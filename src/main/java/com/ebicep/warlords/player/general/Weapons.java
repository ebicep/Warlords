...
public enum Weapons {
    ...
    WARLORDS_II_CREATION_SPLITTER("Creation Splitter", new ItemStack(Material.COPPER_HELMET), LEGENDARY, WeaponsPvE.LEGENDARY),
    WARLORDS_II_DAINSLEIF("Dainsleif", new ItemStack(Material.COPPER_CHESTPLATE), LEGENDARY, WeaponsPvE.LEGENDARY),
    WARLORDS_II_DARK_BLADE("Dark Blade", new ItemStack(Material.COPPER_LEGGINGS), LEGENDARY, WeaponsPvE.LEGENDARY),
    WARLORDS_II_DARK_CLEAVER("Dark Cleaver", new ItemStack(Material.COPPER_BOOTS), LEGENDARY, WeaponsPvE.LEGENDARY),
    ...
    WARLORDS_II_ERUPTION("Eruption", new ItemStack(Material.WOODEN_SPEAR), LEGENDARY, WeaponsPvE.LEGENDARY),
    WARLORDS_II_DIVINE_JUSTICE("Divine Justice", new ItemStack(Material.STONE_SPEAR), LEGENDARY, WeaponsPvE.LEGENDARY),
    WARLORDS_II_DIVINE_REAPER("Divine Reaper", new ItemStack(Material.COPPER_SPEAR), LEGENDARY, WeaponsPvE.LEGENDARY),
    WARLORDS_II_DIVINE_PUNISHER("Divine Punisher", new ItemStack(Material.IRON_SPEAR), LEGENDARY, WeaponsPvE.LEGENDARY),
    WARLORDS_II_RHITTA("Rhitta", new ItemStack(Material.GOLDEN_SPEAR), LEGENDARY, WeaponsPvE.LEGENDARY),
    WARLORDS_II_DRAGON_SLAYING_BLADE("Dragon Slaying blade", new ItemStack(Material.DIAMOND_SPEAR), LEGENDARY, WeaponsPvE.LEGENDARY),
    WARLORDS_II_EDGE_OF_THE_ASTRAL_PLANE("Edge Of The Astral Plane", new ItemStack(Material.NETHERITE_SPEAR), LEGENDARY, WeaponsPvE.LEGENDARY),
    ...
    WARLORDS_II_STOP_SIGN("Stop Sign", new ItemStack(Material.BIRCH_SHELF), LEGENDARY, WeaponsPvE.LEGENDARY),
    ...
    WARLORDS_II_AWAKENED_LICHBLADE("Awakened Lichblade", new ItemStack(Material.COPPER_LANTERN), LEGENDARY, WeaponsPvE.LEGENDARY),
    ...
    WARLORDS_II_TRUE_EXCALIBUR("True Excalibur", new ItemStack(Material.WAXED_COPPER_LANTERN), LEGENDARY, WeaponsPvE.LEGENDARY),
