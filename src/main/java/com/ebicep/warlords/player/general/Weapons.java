...
public enum Weapons {
    ...
    WARLORDS_II_DAINSLEIF("Dainsleif", new ItemStack(Material.ECHO_SHARD), LEGENDARY, WeaponsPvE.LEGENDARY),
    WARLORDS_II_DARK_BLADE("Dark Blade", new ItemStack(Material.SLIME_BALL), LEGENDARY, WeaponsPvE.LEGENDARY),
    WARLORDS_II_DARK_CLEAVER("Dark Cleaver", new ItemStack(Material.BLAZE_POWDER), LEGENDARY, WeaponsPvE.LEGENDARY),
    ...
    WARLORDS_II_ERUPTION("Eruption", new ItemStack(Material.GUNPOWDER), LEGENDARY, WeaponsPvE.LEGENDARY),
    WARLORDS_II_DIVINE_JUSTICE("Divine Justice", new ItemStack(Material.CLAY_BALL), LEGENDARY, WeaponsPvE.LEGENDARY),
    WARLORDS_II_DIVINE_REAPER("Divine Reaper", new ItemStack(Material.CHARCOAL), LEGENDARY, WeaponsPvE.LEGENDARY),
    WARLORDS_II_DIVINE_PUNISHER("Divine Punisher", new ItemStack(Material.FEATHER), LEGENDARY, WeaponsPvE.LEGENDARY),
    WARLORDS_II_RHITTA("Rhitta", new ItemStack(Material.RABBIT_HIDE), LEGENDARY, WeaponsPvE.LEGENDARY),
    WARLORDS_II_DRAGON_SLAYING_BLADE("Dragon Slaying blade", new ItemStack(Material.PHANTOM_MEMBRANE), LEGENDARY, WeaponsPvE.LEGENDARY),
    WARLORDS_II_EDGE_OF_THE_ASTRAL_PLANE("Edge Of The Astral Plane", new ItemStack(Material.HEART_OF_THE_SEA), LEGENDARY, WeaponsPvE.LEGENDARY),
    ...
    WARLORDS_II_CREATION_SPLITTER("Creation Splitter", new ItemStack(Material.AMETHYST_SHARD), LEGENDARY, WeaponsPvE.LEGENDARY),
