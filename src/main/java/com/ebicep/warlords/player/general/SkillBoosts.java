...
public enum SkillBoosts {
                ...
                if (abstractAbility instanceof Fireball fireball) {
                    fireball.getDamageValues()
                            ...
                            .forEachValue(floatModifiable -> {
                                floatModifiable.addModifier(FloatModifiable.ModifierType.ADDITIVE_MULTIPLIER, "Skill Boost", .1f);
                            });
            ...
            abstractAbility -> {
                if (abstractAbility instanceof FlameBurst flameBurst) {
                    flameBurst.getDamageValues()
                              .getFlameBurstDamage()
                              .forEachValue(floatModifiable -> {
                                  floatModifiable.addModifier(FloatModifiable.ModifierType.ADDITIVE_MULTIPLIER, "Skill Boost", .25f);
                              });
    ...
    TIME_WARP_PYROMANCER("Time Warp",
            ...
            abstractAbility -> {
                if (abstractAbility instanceof TimeWarpPyromancer timeWarp) {
                    ...
                    abstractAbility.getCooldown().addModifier(FloatModifiable.ModifierType.MULTIPLICATIVE_MULTIPLIER, "Skill Boost", .45f);
                }
            }
    ),
    ARCANE_SHIELD_PYROMANCER("Arcane Shield",
            ...
            abstractAbility -> {
                if (abstractAbility instanceof AbstractArcaneShield) {
                    abstractAbility.getEnergyCost().addModifier(FloatModifiable.ModifierType.MULTIPLICATIVE_MULTIPLIER, "Skill Boost", 0);
                    abstractAbility.getCooldown().addModifier(FloatModifiable.ModifierType.MULTIPLICATIVE_MULTIPLIER, "Skill Boost", .45f);
                }
            }
    ),
    ...
    FREEZING_BREATH("Freezing Breath",
            ...
            abstractAbility -> {
                if (abstractAbility instanceof FreezingBreath) {
                    abstractAbility.getCooldown().addModifier(FloatModifiable.ModifierType.MULTIPLICATIVE_MULTIPLIER, "Skill Boost", .7f);
                }
            }
    ),
    TIME_WARP_CRYOMANCER("Time Warp",
            ...
            abstractAbility -> {
                if (abstractAbility instanceof TimeWarpCryomancer) {
                    abstractAbility.getCooldown().addModifier(FloatModifiable.ModifierType.MULTIPLICATIVE_MULTIPLIER, "Skill Boost", .6f);
                }
            }
    ),
    ...
    WATER_BREATH("Water Breath",
            ...
            abstractAbility -> {
                if (abstractAbility instanceof WaterBreath) {
                    abstractAbility.getCooldown().addModifier(FloatModifiable.ModifierType.MULTIPLICATIVE_MULTIPLIER, "Skill Boost", .85f);
    ...
    ARCANE_SHIELD_AQUAMANCER("Arcane Shield",
            ...
            abstractAbility -> {
                if (abstractAbility instanceof AbstractArcaneShield) {
                    abstractAbility.getEnergyCost().addModifier(FloatModifiable.ModifierType.MULTIPLICATIVE_MULTIPLIER, "Skill Boost", 0);
                    abstractAbility.getCooldown().addModifier(FloatModifiable.ModifierType.MULTIPLICATIVE_MULTIPLIER, "Skill Boost", .5f);
                }
            }
    ),
    HEALING_RAIN("Healing Rain",
            ...
            abstractAbility -> {
                if (abstractAbility instanceof HealingRain healingRain) {
                    ...
                    abstractAbility.getCooldown().addModifier(FloatModifiable.ModifierType.MULTIPLICATIVE_MULTIPLIER, "Skill Boost", .8f);
                }
            }
    ),
            ...
            abstractAbility -> {
                if (abstractAbility instanceof SeismicWaveBerserker seismicWaveBerserker) {
                    seismicWaveBerserker.getDamageValues()
                                        .getWaveDamage()
                                        .forEachValue(floatModifiable -> {
                                            floatModifiable.addModifier(FloatModifiable.ModifierType.ADDITIVE_MULTIPLIER, "Skill Boost", .15f);
                                        });
                    abstractAbility.getCooldown().addModifier(FloatModifiable.ModifierType.MULTIPLICATIVE_MULTIPLIER, "Skill Boost", .75f);
                }
            }
    ),
            ...
            abstractAbility -> {
                if (abstractAbility instanceof GroundSlamBerserker groundSlamBerserker) {
                    groundSlamBerserker.getDamageValues()
                                       .getSlamDamage()
                                       .forEachValue(floatModifiable -> {
                                           floatModifiable.addModifier(FloatModifiable.ModifierType.ADDITIVE_MULTIPLIER, "Skill Boost", .4f);
                                       });
                    abstractAbility.getEnergyCost().addModifier(FloatModifiable.ModifierType.MULTIPLICATIVE_MULTIPLIER, "Skill Boost", 0);
                }
            }
    ...
    BLOOD_LUST("Blood Lust",
            ...
            abstractAbility -> {
                if (abstractAbility instanceof BloodLust bloodLust) {
                    ...
                    abstractAbility.getCooldown().addModifier(FloatModifiable.ModifierType.MULTIPLICATIVE_MULTIPLIER, "Skill Boost", .65f);
                }
            }
    ),
    BERSERK("Berserk",
    ...
    LAST_STAND("Last Stand",
            ...
            abstractAbility -> {
                if (abstractAbility instanceof LastStand lastStand) {
                    ...
                    abstractAbility.getCooldown().addModifier(FloatModifiable.ModifierType.MULTIPLICATIVE_MULTIPLIER, "Skill Boost", .9f);
                }
            }
    ),
            ...
            abstractAbility -> {
                if (abstractAbility instanceof OrbsOfLife orbsOfLife) {
                    orbsOfLife.getHealValues()
                              .getOrbHealing()
                              .forEachValue(floatModifiable -> {
                                  floatModifiable.addModifier(FloatModifiable.ModifierType.ADDITIVE_MULTIPLIER, "Skill Boost", .2f);
                              });
                }
            }
    ),
            ...
            abstractAbility -> {
                if (abstractAbility instanceof ConsecrateCrusader consecrateCrusader) {
                    ...
                    consecrateCrusader.getDamageValues()
                                      .getConsecrateDamage()
                                      .forEachValue(floatModifiable -> {
                                          floatModifiable.addModifier(FloatModifiable.ModifierType.ADDITIVE_MULTIPLIER, "Skill Boost", .35f);
                                      });
                }
            }
    ),
            ...
            abstractAbility -> {
                if (abstractAbility instanceof ChainHeal chainHeal) {
                    chainHeal.getHealValues()
                             .getChainHealing()
                             .forEachValue(floatModifiable -> {
                                 floatModifiable.addModifier(FloatModifiable.ModifierType.ADDITIVE_MULTIPLIER, "Skill Boost", .3f);
                             });
                }
            }
    ),
    ...
    SOUL_SWITCH("Soul Switch",
            ...
            abstractAbility -> {
                if (abstractAbility instanceof SoulSwitch soulSwitch) {
                    ...
                    abstractAbility.getCooldown().addModifier(FloatModifiable.ModifierType.MULTIPLICATIVE_MULTIPLIER, "Skill Boost", .4f);
                }
            }
    ),
            ...
            abstractAbility -> {
                if (abstractAbility instanceof ImpalingStrike impalingStrike) {
                    ...
                    impalingStrike.getDamageValues()
                                  .getStrikeDamage()
                                  .forEachValue(floatModifiable -> {
                                      floatModifiable.addModifier(FloatModifiable.ModifierType.ADDITIVE_MULTIPLIER, "Skill Boost", .125f);
                                  });
                }
            }
    ),
    ...
    ENERGY_SEER_CONJURER("Energy Seer",
            ...
            abstractAbility -> {
                if (abstractAbility instanceof EnergySeerConjurer) {
                    abstractAbility.getCooldown().addModifier(FloatModifiable.ModifierType.MULTIPLICATIVE_MULTIPLIER, "Skill Boost", .55f);
                }
            }
    ),
            ...
            abstractAbility -> {
                if (abstractAbility instanceof MercifulHex mercifulHex) {
                    mercifulHex.getHealValues()
                               .getHexDOTHealing()
                               .forEachValue(floatModifiable -> {
                                   floatModifiable.addModifier(FloatModifiable.ModifierType.ADDITIVE_MULTIPLIER, "Skill Boost", 1.0f);
                               });
