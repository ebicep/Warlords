...
public class PrismGuard extends AbstractAbility {
    ...
    public boolean onActivate(@Nonnull AbstractWarlordsEntity wp, @Nonnull Player player) {
        ...
        Set<AbstractWarlordsEntity> isInsideBubble = new HashSet<>();
        HashMap<AbstractWarlordsEntity, Integer> timeInBubble = new HashMap<>();
        ...
        wp.getCooldownManager().addCooldown(new RegularCooldown<PrismGuard>(
                ...
                cooldownManager -> {
                    ...
                    for (Map.Entry<AbstractWarlordsEntity, Integer> entry : timeInBubble.entrySet()) {
                ...
                (cooldown, ticksLeft, counter) -> {
                    ...
                    if (counter % 3 == 0) {
                        ...
                        for (AbstractWarlordsEntity enemyInsideBubble : PlayerFilter
                        ...
                        for (AbstractWarlordsEntity bubblePlayer : PlayerFilter
                                .entitiesAround(wp, bubbleRadius, bubbleRadius, bubbleRadius)
