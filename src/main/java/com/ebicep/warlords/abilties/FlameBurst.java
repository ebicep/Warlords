        ...
        for (WarlordsEntity nearEntity : PlayerFilter
            ...
            if (pveUpgrade) {
                nearEntity.addDamageInstance(
                        shooter,
                        name,
                        minDamageHeal + (int) Math.pow(currentLocation.distanceSquared(startingLocation), 0.725),
                        maxDamageHeal + (int) Math.pow(currentLocation.distanceSquared(startingLocation), 0.725),
                        critChance + (int) Math.pow(currentLocation.distanceSquared(startingLocation), 0.725),
                        critMultiplier + (int) Math.pow(currentLocation.distanceSquared(startingLocation), 0.725),
                        false
                );
            } else {
                nearEntity.addDamageInstance(
