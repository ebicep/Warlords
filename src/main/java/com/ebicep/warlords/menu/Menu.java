...
public class Menu extends AbstractMenuBase {
    ...
    public void doOnClickAction(InventoryClickEvent event) {
        ...
        //- not air
        //- something with size
        if (inventory != null && event.getClickedInventory().equals(inventory) && event.getCurrentItem() != null && event.getCurrentItem().getType() != Material.AIR && event.getRawSlot() < inventory.getSize()) {
