...
public class Projectile extends AbstractAbility {
    ...
    public List<Projectile.CustomProjectile> customProjectiles = new ArrayList<>();
    ...
    public void onActivate(Player player) {
        ...
        customProjectiles.add(customProjectile);
            ...
            public void run() {
                ...
                for (int i = 0; i < customProjectiles.size(); i++) {
                    ...
                    if ((location.getWorld().getBlockAt(location).getType() != Material.AIR && location.getWorld().getBlockAt(location).getType() != Material.WATER) && !hitPlayer) {
                        ...
                        //TODO rework so damage is reduced instead of projectile disappearing
                        customProjectiles.remove(i);
                        i--;
                    }
